...
// MovieCard.jsx is a functional component that takes in two props, allMovieData and loading. allMovieData is an array of objects that contain the movie title, year, and poster. The component maps over the allMovieData array and displays each movie card with the title, year, and poster image. If the loading prop is true, a loading spinner is displayed. The component uses Tailwind CSS classes for styling.